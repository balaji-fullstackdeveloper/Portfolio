const socialLinks = [
  {
    href: "https://github.com/balaji-fullstackdeveloper/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  // {
  //   href: "https://www.linkedin.com/in/balaji-d-aa4b4a286/",
  //   icon: (
  //     <svg
  //       width="24"
  //       height="24"
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_8njbzow", "template_9vz2i3p", form.current, {
        publicKey: "gNB6joKw7QhvlnbMs",
      })
      .then(
        () => {
          console.log("SUCCESS!");
